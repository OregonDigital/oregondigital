    ...
    module Facets
      ...
      included do
        configure_blacklight do |config|
          ...
          config.add_facet_field solr_name('desc_metadata__subject_label', :facetable), :label => 'Topic', :limit => 20, :helper_method => :controlled_view
          config.add_facet_field solr_name('desc_metadata__location', :facetable), :label => 'Region'
          config.add_facet_field solr_name('desc_metadata__set_label', :facetable), :label => 'Collection', :helper_method => :controlled_view
