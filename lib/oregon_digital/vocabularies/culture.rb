...
module OregonDigital::Vocabularies
  class CULTURE < OregonDigital::RDF::TripleStrictVocabulary("http://opaquenamespace.org/ns/culture/")
    ...
    # Concept terms
    property :"Ababdah", :label => 'Ababdah', :comment =>
    ...
    property :"Alsatian", :label => 'Alsatian', :comment =>
      %(Getty Appendices.)
    property :"AncientItalian", :label => 'Ancient Italian', :comment =>
      %(Getty Appendices.)
    property :"Andean", :label => 'Andean', :comment =>
      %(Damian, Carol; Virgin of the Andes; Art and Ritual in Colonial
        Cuzco, Miami Beach: Grassfield Press, 1995.)
    property :"Angoonpeople", :label => 'Angoon people', :comment =>
      %(Term derived from the Tribal Legacies collection)
    property :"BatakSumatran", :label => 'Batak (Sumatran)', :comment =>
    ...
    property :"Belanda", :label => 'Belanda', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        ...
        Sudanic language)
    property :"BeringStraitInuit", :label => 'Bering Strait Inuit', :comment =>
      %(Lee, Molly and Gregory A. Reinhardt; Eskimo Architecture:
        ...
        Language: ?)
    property :"Biwat", :label => 'Biwat', :comment =>
      %(Gealt, Adelheid, et al.; Masterworks from the Indiana
        University Art Museum, Bloomington, IN: Indiana University
        Press, 2007. Middle Yuat River, lower Sepik River area, Papua
        New Guinea people, aka Mundugumor)
    property :"Bolognese", :label => 'Bolognese', :comment =>
      %(Getty Appendices.)
    property :"BosnianHerzegovinian", :label => 'Bosnian, Herzegovinian', :comment =>
      %(Getty Appendices.)
    property :"Cabinda", :label => 'Cabinda', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. Congo Republic region/enclave in the Congo
        Republic but the term is sometimes used to refer to the art of
        the Vili peoples)
    property :"CeliloFallsIndians", :label => 'Celilo Falls Indians', :comment =>
      %(Term derived from the Tribal Legacies collection)
    property :"ChelukemaukesIndians", :label => 'Chelukemaukes Indians', :comment =>
      %(Term derived from the Tribal Legacies collection)
    property :"ChetlesssentinsIndians", :label => 'Chetlesssentins Indians', :comment =>
      %(Term derived from the Tribal Legacies collection)
    property :"ChineseHongKong", :label => 'Chinese/Hong Kong', :comment =>
      %(Getty Appendices.)
    property :"Chippewah", :label => 'Chippewah', :comment =>
    ...
    property :"Chokwe", :label => 'Chokwe', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
    ...
    property :"ClatsopIndians", :label => 'Clatsop Indians', :comment =>
      %(Term derived from the Tribal Legacies collection)
    property :"Clowella", :label => 'Clowella', :comment =>
      %(Term derived from the Tribal Legacies collection)
    property :"ColumbiaRiverTribes", :label => 'Columbia River Tribes', :comment =>
      %(Term derived from the Tribal Legacies collection)
    property :"Corinthian", :label => 'Corinthian', :comment =>
      %(Getty Appendices.)
    property :"Corsican", :label => 'Corsican', :comment =>
      %(Getty Appendices.)
    property :"Da", :label => 'Da', :comment =>
    ...
    property :"Daunian", :label => 'Daunian', :comment =>
      %(http://en.wikipedia.org/wiki/Daunia. The Daunia is a
        ...
        Romans.)
    property :"DhoLuo", :label => 'Dho Luo', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
    ...
    property :"DutchAmerican", :label => 'Dutch-American', :comment =>
      %(Americans of Dutch descent)
    property :"EastGreenlandInuit", :label => 'East Greenland Inuit', :comment =>
      %(Lee, Molly and Gregory A. Reinhardt; Eskimo Architecture:
        Dwelling and Structure in the Early Historic Period,
        Fairbanks: University of Alaska Press and University of Alaska
        Museum, 2003. United States, ARCTIC: eastern coast of
        Greenland Language: Inuit)
    property :"Etretrian", :label => 'Etretrian', :comment =>
      %(. Term used by Steven Lowenstam)
    property :"Euboian", :label => 'Euboian', :comment =>
      %(Getty Appendices. Euboean)
    property :"Falerian", :label => 'Falerian', :comment =>
      %(http://www.merriam-webster.com/dictionary/falerian. Of or
        relating to the ancient Etruscan city of Falerii.)
    property :"Florentine", :label => 'Florentine', :comment =>
      %(Getty Appendices.)
    property :"FrenchPolynesian", :label => 'French Polynesian', :comment =>
    ...
    property :"GreekAmerican", :label => 'Greek-American', :comment =>
      %(Americans of Greek descent)
    property :"Huari", :label => 'Huari', :comment =>
      %(Gealt, Adelheid, et al.; Masterworks from the Indiana
        University Art Museum, Bloomington, IN: Indiana University
        Press, 2007.)
    property :"Hungana", :label => 'Hungana', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. Zaire Alternate name: Bahuana, Bahungana,
        Huana, Hungaan, Hungana, Hunganna, Wana SOUTH SAVANNA Bantu
        language)
    property :"HungarianAmerican", :label => 'Hungarian-American', :comment =>
      %(Americans of Hungarian descent)
    property :"Hunkapapa", :label => 'Hunkapapa', :comment =>
    ...
    property :"Isaaq", :label => 'Isaaq', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. Somalia Alternate name: Issaq Cushitic
        language; clan-family of the Somali)
    property :"Itakete", :label => 'Itakete', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. Nigeria Kwa language; subcategory of the
        Yoruba)
    property :"JapaneseAmerican", :label => 'Japanese-American', :comment =>
      %(Americans of Japanese descent)
    property :"Kalabari", :label => 'Kalabari', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        ...
        subcategories.)
    property :"Kambot", :label => 'Kambot', :comment =>
      %(Gealt, Adelheid, et al.; Masterworks from the Indiana
        University Art Museum, Bloomington, IN: Indiana University
        Press, 2007. Lower Sepik River, Papua New Guinea people, aka
        Tindama, Tin Dama)
    property :"KazakChina", :label => 'Kazak (China)', :comment =>
    ...
    property :"Klickitat", :label => 'Klickitat', :comment =>
    ...
    property :"Kom", :label => 'Kom', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
    ...
    property :"Konkombwa", :label => 'Konkombwa', :comment =>
    ...
    property :"KotzebueSoundInuit", :label => 'Kotzebue Sound Inuit', :comment =>
      %(Lee, Molly and Gregory A. Reinhardt; Eskimo Architecture:
        Dwelling and Structure in the Early Historic Period,
        Fairbanks: University of Alaska Press and University of Alaska
        Museum, 2003. United States, ARCTIC: West coast of alaska
        Language: ?)
    property :"Li", :label => 'Li', :comment =>
      %(Feng, Hanji and Huang, Bangjie; National minority costume in
        China, Hong Kong: Hui yan ya ji, 1985.)
    property :"Lukanian", :label => 'Lukanian', :comment =>
    ...
    property :"Luluwa", :label => 'Luluwa', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        ...
        USES LULUA)
    property :"LumboCongoRepublicGabon", :label => 'Lumbo (Congo Republic, Gabon)', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. Congo Republic, Gabon Alternate name:
        Balumbo, Loumbou, Lumbu Bantu language)
    property :"Macedonian", :label => 'Macedonian', :comment =>
      %(Getty Appendices. Ancient Macedonian)
    property :"MamlukAfricangroup", :label => 'Mamluk (African group)', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. CENTRAL-EAST SUDAN)
    property :"Masai", :label => 'Masai', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. EAST AFRICA)
    property :"Mawri", :label => 'Mawri', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. Niger Alternate name: Mauri Chadic language;
        subcategory of the Hausa)
    property :"Milanese", :label => 'Milanese', :comment =>
      %(Getty Appendices.)
    property :"Minianka", :label => 'Minianka', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. Mali Alternate name: Minyanka Gur language;
        sometimes considered a Senufo subcategory)
    property :"Molallapeople", :label => 'Molalla people', :comment =>
      %(Term derived from the Tribal Legacies collection)
    property :"MongolChina", :label => 'Mongol (China)', :comment =>
      %(Feng, Hanji and Huang, Bangjie; National minority costume in
        ...
        the horseback\'.)
    property :"Montenegrin", :label => 'Montenegrin', :comment =>
      %(Getty Appendices.)
    property :"Montol", :label => 'Montol', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. Nigeria Chadic language)
    property :"Mossi", :label => 'Mossi', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        ...
        various l)
    property :"Ndebele", :label => 'Ndebele', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
    ...
    property :"NorthernMadak", :label => 'Northern Madak', :comment =>
      %(Gealt, Adelheid, et al.; Masterworks from the Indiana
        University Art Museum, Bloomington, IN: Indiana University
        Press, 2007.)
    property :"Ntandu", :label => 'Ntandu', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. Zaire Alternate name: Bantandu Bantu
        language; subcategory of the Kongo)
    property :"Oaxacan", :label => 'Oaxacan', :comment =>
      %(Gealt, Adelheid, et al.; Masterworks from the Indiana
        University Art Museum, Bloomington, IN: Indiana University
        Press, 2007.)
    property :"Peloponnesian", :label => 'Peloponnesian', :comment =>
      %(Getty Appendices.)
    property :"Pende", :label => 'Pende', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
    ...
    property :"Pergamanes", :label => 'Pergamanes', :comment =>
      %(. Culture related to the city of Pergamon in Ancient Greece.)
    property :"Phocaen", :label => 'Phocaen', :comment =>
      %(. Term used by Steven Lowenstam)
    property :"PlumBayouCulture", :label => 'Plum Bayou Culture', :comment =>
      %(http://www.encyclopediaofarkansas.net/encyclopedia/entry-detail.aspx?entryID=547.
        ...
        Baytown culture)
    property :"Punu", :label => 'Punu', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. Congo Republic, Gabon Alternate name: Apono,
        Bapunu, Pounou, Puno Bantu language)
    property :"Rendile", :label => 'Rendile', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. Kenya Cushitic language)
    property :"Rhenish", :label => 'Rhenish', :comment =>
      %(Getty Appendices.)
    property :"RongowhakaataMaori", :label => 'Rongowhakaata (Maori)', :comment =>
      %(Gealt, Adelheid, et al.; Masterworks from the Indiana
        University Art Museum, Bloomington, IN: Indiana University
        Press, 2007.)
    property :"Saka", :label => 'Saka', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. Zaire Alternate name: Bosaka Bantu language;
        subcategory of Mongo)
    property :"Samosian", :label => 'Samosian', :comment =>
      %(. Culture related to the island of Samos in Ancient Greece)
    property :"Sidonian", :label => 'Sidonian', :comment =>
      %(. Culture related to the Ancient Phoneician port city of
        Sidonia or Sidon.)
    property :"Sienese", :label => 'Sienese', :comment =>
      %(Getty Appendices.)
    property :"Singapore", :label => 'Singapore', :comment =>
      %(Getty Appendices. Singaporean)
    property :"Somaligroup", :label => 'Somali (group)', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. Djibouti, Ethiopia, Kenya, Somalia Cushitic
        language)
    property :"SouthKorean", :label => 'South Korean', :comment =>
      %(Getty Appendices.)
    property :"Soviet", :label => 'Soviet', :comment =>
      %(Getty Appendices.)
    property :"SpanishAmerican", :label => 'Spanish-American', :comment =>
      %(Americans of Spanish descent)
    property :"St.JohnsCulture", :label => 'St. Johns Culture', :comment =>
    ...
    property :"Swahili", :label => 'Swahili', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
    ...
    property :"Tiwanaku", :label => 'Tiwanaku', :comment =>
      %(Gealt, Adelheid, et al.; Masterworks from the Indiana
        University Art Museum, Bloomington, IN: Indiana University
        Press, 2007.)
    property :"Tooquot", :label => 'Tooquot', :comment =>
      %(Term derived from the Tribal Legacies collection)
    property :"Transylvanian", :label => 'Transylvanian', :comment =>
      %(Getty Appendices.)
    property :"Ukranian", :label => 'Ukranian', :comment =>
      %(Getty Appendices.)
    property :"Usukuma", :label => 'Usukuma', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. EAST AFRICA)
    property :"VaChina", :label => 'Va (China)', :comment =>
      %(Feng, Hanji and Huang, Bangjie; National minority costume in
    ...
    property :"Velezuelan", :label => 'Velezuelan', :comment =>
      %(Getty Appendices.)
    property :"WaChina", :label => 'Wa (China)', :comment =>
      %(Feng, Hanji and Huang, Bangjie; National minority costume in
        China, Hong Kong: Hui yan ya ji, 1985.)
    property :"WallisandFutunaIslander", :label => 'Wallis and Futuna Islander', :comment =>
      %(Leymarie, Jean; French Painting: The Nineteenth Century,
        Cleveland: World Publishing Company, 1962.)
    property :"WestGreenlandInuit", :label => 'West Greenland Inuit', :comment =>
      %(Lee, Molly and Gregory A. Reinhardt; Eskimo Architecture:
        Dwelling and Structure in the Early Historic Period,
        Fairbanks: University of Alaska Press and University of Alaska
        Museum, 2003. United States, ARCTIC: western coast of
        Greenland Language: Inuit)
    property :"YaoChina", :label => 'Yao (China)', :comment =>
    ...
    property :"Yemeni", :label => 'Yemeni', :comment =>
      %(Getty Appendices.)
    property :"Yoruba", :label => 'Yoruba', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. Benin, Nigeria, Togo Alternate name: Yorba,
        Yorouba Kwa language; the Yoruba kingdoms date from circa
        1000. to the present.)
    property :"YorubaOwo", :label => 'Yoruba Owo', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. CENTRAL GUINEA COAST)
    property :"YorubaOyo", :label => 'Yoruba Oyo', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. CENTRAL GUINEA COAST)
    property :"Zulu", :label => 'Zulu', :comment =>
      %(Biebuyck, Daniel P., Susan Kelliher and Linda McRae; African
        Ethnonyms: Index to Art-Producing People of Africa, New York:
        G. K. Hall, 1996. Lesotho, Malawi, South Africa, Swaziland
        Alternate name: Amazulu Bantu language)
    property :"laconic", :label => 'laconic', :comment =>
      %(Getty Appendices. Laconian)
    property :"undetermined", :label => 'undetermined', :comment =>
      %(Getty Appendices.)
