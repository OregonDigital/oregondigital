    ...
    if [ -f /etc/debian_version ]; then
      ...
      case "$DISTRO" in
        ...
        precise|wheezy|maya)
          ...
          apt-get update
          apt-get install --show-progress -y automake build-essential libgirepository1.0-dev gobject-introspection gtk-doc-tools libglib2.0-dev libjpeg-turbo8-dev libpng12-dev libwebp-dev libtiff4-dev libexif-dev libgsf-1-dev liblcms2-dev libxml2-dev swig libmagickcore5 libmagickcore5-extra libmagickcore-dev curl
