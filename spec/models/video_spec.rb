  ...
  describe "#create_derivatives" do
    ...
    context "when it has a video datastream" do
      ...
      it "should create a thumbnail" do
        mime_type = FileMagic.new(FileMagic::MAGIC_MIME).file(subject.thumbnail_location).split(';')[0]
