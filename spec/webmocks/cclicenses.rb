RSpec.configure do |config|
  config.before(:each) do
    stub_request(:get, "http://creativecommons.org/licenses/by-nc-nd/4.0/").
      ...
      to_return(:status => 200, :body => lambda {|request| "<#{request.uri.to_s.gsub(":80","")}> <http://purl.org/dc/terms/title> \"Attribution-NonCommercial-NoDerivatives 4.0 International\"@en .'"}, :headers => {:'Content-Type' => 'application/n-triples'})
  end
end
