RSpec.configure do |config|
  config.before(:each) do
    stub_request(:get, "http://id.loc.gov/authorities/subjects/sh85050282").
        ...
        to_return(:status => 200, :body => '<http://id.loc.gov/authorities/subjects/sh85050282> <http://www.w3.org/2004/02/skos/core#prefLabel> "Food industry and trade"@en .', :headers => {:'Content-Type' => 'application/n-triples'})
  end
end
