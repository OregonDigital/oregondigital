...
//______________________________________________________________________________
    BookReader.prototype.init = function() {
        ...
        if (this.protected) {
            $('body').on('contextmenu dragstart', '.BRpagediv1up', this, function(e) {
                return false;
            });
            $('body').on('contextmenu dragstart', '.BRpageimage', this, function(e) {
                return false;
            });
            $('body').on('contextmenu dragstart', '.BRpagedivthumb', this, function(e) {
                return false;
            });
...
// animated scrolling)
    ...
    BookReader.prototype.lazyLoadImage = function (dummyImage) {
        ...
        $(img)
            ...
            .one('load', function() {
                //if (console) { console.log(' onload ' + $(this).prop('src').match('([0-9]{4}).jp2')[1]); };
            ...
            //the width set with .prop is ignored by Internet Explorer, causing it to show the image at its original size
...
// div requires adjusting the offset of BRtwpageview and/or scrolling in BRcontent.
    BookReader.prototype.prepareTwoPageView = function(centerPercentageX, centerPercentageY) {
        ...
        /* Flip areas no longer used
         ...
         $(this.twoPage.leftFlipArea).prop('id', 'BRleftflip').css({
         border: '0',
         ...
         $(this.twoPage.rightFlipArea).prop('id', 'BRrightflip').css({
         border: '0',
         width:  this.twoPageFlipAreaWidth() + 'px',
         height: this.twoPageFlipAreaHeight() + 'px',
         position: 'absolute',
    ...
    BookReader.prototype.initToolbar = function(mode, ui) {
        ...
        $("#BookReader").append(
            "<div id='BRtoolbar'>"
                ...
                //+     "<button class='BRicon full'></button>"
                +   "</span>"
                +   "<span></span>" // <a class='logo' href='" + this.logoURL + "'></a></span>"
...
// Bind navigation handlers
    BookReader.prototype.bindNavigationHandlers = function() {
        ...
        this.initSwipeData();
        $('body').off('mousemove.navigation', '#BookReader');
        $('body').on('mousemove.navigation', '#BookReader',
            { 'br': this},
            this.navigationMousemoveHandler
        );
        $('body').off('mousedown.swipe', '.BRpageimage');
        $('body').on('mousedown.swipe', '.BRpageimage',
            { 'br': this},
