class Datastream::OregonRDF < OregonDigital::QuadResourceDatastream
  ...
  property :donor, :predicate => OregonDigital::Vocabularies::MARCREL.dnr, :class_name => OregonDigital::ControlledVocabularies::Creator do |index|
    index.as :searchable, :facetable, :displayable
  end
  ...
  property :designer, :predicate => OregonDigital::Vocabularies::MARCREL.dsr, :class_name => OregonDigital::ControlledVocabularies::Creator do |index|
    index.as :searchable, :displayable
  end
  ...
  property :primarySet, :predicate => OregonDigital::Vocabularies::OREGONDIGITAL.primarySet, :class_name => "GenericCollection" do |index|
    index.as :searchable, :displayable, :stored_sortable
  end
